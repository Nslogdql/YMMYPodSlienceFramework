#
# Be sure to run `pod lib lint YMMYPodSlienceFramework.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'YMMYPodSlienceFramework/Classes/**/*'
  
  # s.resource_bundles = {
  #   'YMMYPodSlienceFramework' => ['YMMYPodSlienceFramework/Assets/*.png']
  # }
